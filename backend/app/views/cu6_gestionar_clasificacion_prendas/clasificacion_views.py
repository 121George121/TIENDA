...
# Ubicación: backend/app/views/cu6_gestionar_clasificacion_prendas/clasificacion_views.py
# ==============================================================================
...
router = APIRouter(
    tags=["Clasificación de Prendas (CU06 - Vista API)"],
)
...
def listar_categorias(
    ...
    """Listar categorías de prendas (Público)"""
...
def crear_categoria(
    ...
    """Crear categoría (Solo Personal / Administrador)"""
...
def actualizar_categoria(
    ...
    """Actualizar categoría (Solo Personal / Administrador)"""
...
def baja_categoria(
    ...
    """Baja de categoría (Solo Administrador)"""
...
def crear_temporada(
    ...
    """Crear temporada (Solo Personal / Administrador)"""
...
def actualizar_temporada(
    ...
    """Actualizar temporada (Solo Personal / Administrador)"""
...
def baja_temporada(
    ...
    """Baja de temporada (Solo Administrador)"""
...
def crear_coleccion(
    ...
    """Crear colección (Solo Personal / Administrador)"""
...
def actualizar_coleccion(
    ...
    """Actualizar colección (Solo Personal / Administrador)"""
...
def baja_coleccion(
    ...
    """Baja de colección (Solo Administrador)"""
